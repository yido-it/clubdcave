...
<div class="content mt-3 mb-0">
	<div class="row mb-0 px-3">
		...
		<div class="col-6">
			<!-- 자세히보기 -->
			<a href="javascript:location.href='/facility'" class="text-right d-block font-12 color-theme">
...
<div>
<img src="images/gallery/1.jpg" height="100" class="rounded-s shadow-xl">
</div>

<div class="pl-3">
<h4> <span class="badge bg-blue-dark px-2 py-1">B1</span> 오픈타석</h4>
<h5 class="font-14 font-400">최대8인으로 재미있는 게임을 해보세요</h5>
</div>
</div>

<div class="d-flex mb-3">
<div>
<img src="images/gallery/2.jpg" height="100" class="rounded-s shadow-xl">
</div>
<div class="pl-3">
<h4>  <span class="badge bg-red-dark px-2 py-1">1F</span> 카브</h4>
<h5 class="font-14 font-400">최대8인으로 재미있는 게임을 해보세요</h5>
</div>
</div>
...
<div class="d-flex mb-3">
<div>
<img src="images/gallery/3.jpg" height="100" class="rounded-s shadow-xl">
</div>
<div class="pl-3"> 
<h4 class="mt-1">  <span class="badge bg-green-dark px-2 py-1">2F</span> 풀스윙</h4>
<h5 class="font-14 font-400">최고의 소프트웨어로 재미있는 게임을 해보세요</h5>
</div>
</div>
</div> -->
