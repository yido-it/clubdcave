        ...
        <div class="page-content pb-3">  
            <div class="card card-full rounded-m" style="margin-bottom:-10px">
                ...
                <p class="mb-n1 color-highlight font-600 mb-n1">클럽디 카브 비스트로</p>
					...
					클럽디카브는
					타이거 우즈가 공동개발한 골프 시뮬레이터 ‘FULL SWING'과 함께
					세계 명문 골프장이 펼쳐진 스크린에서 생생한 라운드를 즐기며
					전문 셰프의 시그니처 요리와 와인을 맛볼 수 있는
					어반 골프클럽 비스트로입니다.  
					    <br/>   <br/> 
					
					자신만의 전략을 가진 도시인들의 아지트 CLUBD CAVE에서
					골프&미식 라이프를 함께 즐기세요!
					    <br/>   <br/> 
					
					
					※ '클럽디카브'의 모든 레시피는 유럽에서 함께 요리하며 인연을 맺은
					    강민구, 송하슬람 셰프의 브랜드 '마마리 다이닝'에서 기획했습니다.
