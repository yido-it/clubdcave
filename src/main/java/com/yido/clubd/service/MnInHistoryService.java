...
public class MnInHistoryService {
	...
	public ResultVO successPayLogic(Map<String, Object> params, String action, String reserved, HttpSession session) {	
		...
		try {
			...
			if(action.equals("RESERVATION")) {	// RESERVATION = 예약
				...
				log.debug("[successPayLogic] 예약정보 : " + params);
        		...
        		this.afterPayLogic(params, sessionVO);
	...
	//    		commonService.sendSms2(params);
				...
				log.debug("[successPayLogic] 이용권 정보:" + params);
	 ...
	 * @throws Exception
	 */
	public void afterPayLogic(Map<String, Object> param, SessionVO session) throws Exception {

		log.debug("[afterPayLogic] param: {}, session > {},{}", param, session.getMsNum(), session.getMsName());
